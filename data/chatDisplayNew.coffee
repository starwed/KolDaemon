...
class ChatDisplay
	...
	setOwnInfo: (payload) =>
		...
		setClanInfo(tab) for tab in ['clan', 'hobopolis', 'slimetube', 'hauntedhouse', 'private']
		@setSize()
	...
	createGuts: (msg) =>
		...
		try
			...
			if msg.link? and msg.type is 'event' and msg.link isnt 'false' and msg.link isnt fals
